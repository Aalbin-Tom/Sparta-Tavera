// document.getElementById('single-product-img').addEventListener('mouseover',function(){
//  imageZoom('featured')
// })
...
function imageZoom(imgID){
   ...
   lens.style.backgroundImage =`url(${img.src})`
    ...
    if(positionTop > img.width - lens.offsetHeight/ 3){
        positionLeft = img.height - lens.offsetHeight/ 3
    }
